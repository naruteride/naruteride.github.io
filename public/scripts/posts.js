    ...
    db.collection("posts")
      ...
      .then((querySnapshot) => {
        querySnapshot.forEach((doc) => {
          ...
          } else if (nowDate.setUTCHours(-24, 0, 0, 0) < postDateToMillis) { // 오늘 작성되었다면
